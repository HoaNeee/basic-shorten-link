...
const CardItemLink = (props: Props) => {
	...
	return (
		<div className="dark:bg-neutral-800 w-full bg-white rounded-sm shadow-xs">
			<div className="md:flex-row md:items-center dark:border-neutral-600 flex justify-between flex-col gap-10 px-4 py-3 border-b border-gray-100 w-full">
				<div className="md:max-w-7/10 w-full flex items-center gap-4">
					{!isStatistic ? (
						<Checkbox
			...
			<div className="px-8 py-3">
				...
				<div className="dark:text-gray-400 mt-2 mb-4 text-sm text-gray-500 text-ellipsis line-clamp-1">
					{linkState.main_url}
				</div>
